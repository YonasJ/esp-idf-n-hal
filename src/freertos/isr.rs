...
impl InterruptContext {
    ...
    pub fn new() -> InterruptContext { InterruptContext { x_higher_priority_task_woken: 0, } }

    pub unsafe fn get_task_field_mut(&self) -> FreeRtosBaseTypeMutPtr { self.x_higher_priority_task_woken as *mut _ }
}
